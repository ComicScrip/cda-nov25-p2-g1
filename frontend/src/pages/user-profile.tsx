...
const navItems = [
  ...
  { label: "Mes repas", active: false },
  { label: "Mon évolution", active: false },
];

const medicalTags = ["Allergie gluten", "Thrombose", "Anxiété", "Hypertension", "Pose anneau gastrique"];
                      ...
                      <label className="text-xs text-[#4b5a4b] md:col-span-2" htmlFor="birthDate">
                        ...
                        <div className="mt-1 flex flex-wrap items-center gap-2">
                          <input
                            id="birthDate"
                            type="text"
                            defaultValue="12/06/1984"
                            className="min-w-[160px] flex-1 rounded-md border border-[#bdbdbd] bg-white px-3 py-2 text-sm text-[#2c2c2c] shadow-[inset_0_1px_2px_rgba(0,0,0,0.08)] focus:outline-none focus:ring-2 focus:ring-[#9bb59a]"
                          />
                          <select
                            defaultValue="12"
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {medicalTags.map((tag) => (
                          ...
                          >
                            {tag}
                            <span className="inline-flex h-3 w-3 items-center justify-center rounded-full border border-[#6a746a] text-[8px]">
                              ×
                            </span>
                          </span>
                        ))}
                      ...
                      <div className="flex flex-wrap items-center gap-6 text-xs text-[#4b5a4b]">
                        ...
                        <label className="flex items-center gap-2">
                          <input type="radio" name="gender" defaultChecked className="accent-[#7a9378]" />
                          Homme
                        </label>
                        <label className="flex items-center gap-2">
