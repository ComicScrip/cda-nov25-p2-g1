...
export default function UserProfilePage() {
  ...
  return (
    <HomeLayout pageTitle="Profil" footerVariant="userSlim">
      <UserPageLayout activeNav="profile">
        {loading && (
        ...
        <div className="max-w-3xl text-[#2c2c2c]">
          ...
          <p className="mt-1 text-xs text-[#576057]">
            {profileName}, ces infos servent a personnaliser votre parcours sante avec votre coach.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          ...
          {saveError && <p className="text-xs text-[#7b2222]">Erreur: {saveError.message}</p>}
          <button
            type="button"
            onClick={handleSave}
            disabled={isSaving}
